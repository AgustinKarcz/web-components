function main() {
  function getCards() {
    return fetch(
      "https://cdn.contentful.com/spaces/6ncssp2psbh7/environments/master/entries?access_token=NWdoJvA0ABibx5aSgMCO5Kt6Li_hgYNrDfNCtr-9n0E&content_type=serviceCard&sys.id[in]=3dd699JhNTQmoPasQbFuv4,223yASygqGVTdRavP0T2r2,4ParEA9xf0zQybHTGf1MbN"
    )
      .then((res) => res.json())
      .then((data) => {
